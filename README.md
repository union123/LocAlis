...
| Бенчмарк | Результат |
|---|---|
| Terminal-Bench core (срез 20 задач, Lead) | 15% auto / ~30–35% ручная оценка |
| GAIA validation L1 (42 задачи, text-only) | 33% первый прогон |
| LocAlis-Bench v1 (собственный, 12 задач) | регрессионный набор |
